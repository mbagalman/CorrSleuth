...
First release published to PyPI. (0.1.0 exists as a Git tag only.)
...
Initial release (tagged on GitHub only; never published to PyPI — the first
PyPI release is 0.2.0).
...
[0.2.0]: https://github.com/mbagalman/CorrSleuth/compare/v0.1.0...v0.2.0
